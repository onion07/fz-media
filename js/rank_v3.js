...
var APP = (function () {
    ...
    COMM.request = function (arg,callback) {
        // console.info(typeof arguments[0])
        // if (typeof arg !== 'object' || Array.isArray(arg) || typeof callback !== 'function') { return false;}
        if (typeof arg !== 'object' || Object.prototype.toString.call(arg).slice(8, -1).toLowerCase() !== 'object' || typeof callback !== 'function') { return false;}
