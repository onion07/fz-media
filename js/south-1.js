    ...
    var func = {
        ...
        Request : function (arg,callback) {
            ...
            if(window.sessionStorage){
                console.log(!sessionStorage.getItem(arg._key))
                if(!sessionStorage.getItem(arg._key)){
                    $.ajax({
                        url: arg._url,
                        type: arg._type,
                        ...
                        success: function (ret) {
                            //console.log(ret)
                            sessionStorage.setItem(arg._key,ret);
                    ...
                    var ret = JSON.parse(sessionStorage.getItem(arg._key));
                    callback(ret);
                }
            }else{
            ...
            var swiper1 = new Swiper('#rank', {
                ...
                onSlideChangeEnd:function(e){
                    if(e.activeIndex === 2){
                        ...
                        /*图表*/
                        _self.Request( { _url: data_url.south_echart,_type:'GET', _data: {"userId":"5","password":"715d048ca9c63ae12beba3d2a07a24cf","extent":"季度"}, _key:'south_echart_quarter' }, function (ret) { _self.setCharts(ret);});
                        $('.time-scale>li').removeClass('active');
                        $('.time-scale>li:eq(1)').addClass('active');
                    }else if(e.activeIndex === 3){
                        $('#title_toggle').html('个人');
                        /*图表*/
                        _self.Request( { _url: data_url.south_echart,_type:'GET', _data: {"userId":"5","password":"715d048ca9c63ae12beba3d2a07a24cf","extent":"月度"}, _key:'south_echart_month' }, function (ret) { _self.setCharts(ret);});
                        $('.time-scale>li').removeClass('active');
                        $('.time-scale>li:eq(2)').addClass('active');
                    }else if(e.activeIndex === 4){
                        $('#title_toggle').html('团队');
                        /*图表*/
                        _self.Request( { _url: data_url.south_echart,_type:'GET', _data: {"userId":"5","password":"715d048ca9c63ae12beba3d2a07a24cf","extent":"年度"}, _key:'south_echart_year' }, function (ret) { _self.setCharts(ret);});
                        $('.time-scale>li').removeClass('active');
        ...
        init : function(){
            ...
            /*顶部全年数据、南区签约数量、总额*/
            _self.Request( { _url: data_url.south_main, _type:'GET', _data: {"userId": uid,"password": password}, _key:'south_main' }, function (ret) { _self.setMaindata(ret);});
            /*图表*/
            _self.Request( { _url: data_url.south_echart,_type:'GET', _data: {"userId": uid,"password": password,"extent":"年度"}, _key:'south_echart_year' }, function (ret) { _self.setCharts(ret);});
            /*团队月度排行榜*/
            _self.Request( { _url: data_url.south_team_rank,_type:'GET', _data: {"userId": uid,"password": password}, _key: 'south_team_rank'}, function (ret) { _self.teamRank(ret);});
            /*小组月度排行榜*/
            _self.Request( { _url: data_url.south_group_rank,_type:'GET', _data: {"userId": uid,"password": password}, _key:'south_group_rank' }, function (ret) { _self.groupRank(ret);});
            /*个人月度排行榜*/
            _self.Request( { _url: data_url.south_personal_rank,_type:'GET', _data: {"userId": uid,"password": password}, _key:'south_personal_rank' }, function (ret) { _self.personalRank(ret);});
            /*小组完成情况 (单位:元)*/
            _self.Request( { _url: data_url.group_rate,_type:'GET', _data: {"userId": uid,"password": password}, _key: 'group_rate'}, function (ret) { _self.groupRate(ret);});
            /*个人完成情况 (单位:元)*/
            _self.Request( { _url: data_url.personal_rate,_type:'GET', _data: {"userId": uid,"password": password,"cityName":city,"transCompany":trans}, _key:'personal_rate' }, function (ret) { _self.personalRate(ret);});
            /*小组签约合同数量和金额 (本周和本月)*/
            _self.Request( { _url: data_url.group_finish,_type:'GET', _data: {"userId": uid,"password": password}, _key: 'group_finish'}, function (ret) { _self.groupFinish(ret);});
            /*底部消息*/
            _self.Request( { _url: data_url.news,_type:'GET', _data: {"userId": uid,"password": password}, _key:'news' }, function (ret) { _self.getNews(ret);});
